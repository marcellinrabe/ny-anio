...
export default function App() {
  ...
  return (
    <div className={theme}>
        <div className="w-screen h-screen overflow-hidden flex justify-center items-center bg-gray-200 dark:bg-gray-950 transition-all duration-200">
          <div className="w-full max-w-xl bg-white shadow-xl rounded-xl dark:bg-slate-800 dark:text-white transition-none mx-8">
              <FormWithStore/>
              <BreakLine/>
              <ListTodoWithStore/>            
          </div>
